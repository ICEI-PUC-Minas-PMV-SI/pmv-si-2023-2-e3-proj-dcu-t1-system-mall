...
bind_value(':cpf_cadastro', $cpf_cadastro);
...
<head>
    ...
    <link href="../assets/img/administrativo/favicon2.ico" rel="shortcut icon" type="image/x-icon">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="index.php?pag=<?php echo $menu3 ?>">Usuarios</a></li>
                        <li><a class="dropdown-item" href="index.php?pag=<?php echo $menu4 ?>">Níveis de Usuários</a>
                        </li>
                    </ul>
                </li>
            </ul>
            <div class="d-flex mr-4">
                <img class="img-proifle rounded-circle mr-10" src="../../assets/img/administrativo/Avatar.png" width="35px" height="35px">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                           data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item danger" href="../../config/logout.php">Sair</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<script type="text/javascript" src="../../assets/js/inserir.js"></script>
